 ...
 * @date 2022/7/4 14:08
 */
public class CzSpc302KSRuleDProcessFunction extends ProcessFunction<SpcCz302KSDetailDTO, SpcCz302KSDetailDTO> implements SpcProcessService {
    ...
    public void processElement(SpcCz302KSDetailDTO value, ProcessFunction<SpcCz302KSDetailDTO, SpcCz302KSDetailDTO>.Context ctx, Collector<SpcCz302KSDetailDTO> out) throws Exception {
        ...
        //获取窗口
        LimitLinkedList<SpcCz302KSDetailDTO> flexDataList = windowService.getDataWindow(value.getTaskKey(), RuleKey.RULE_D, windowKey, REDIS_FLEX_TYPE_KEY, ruleValue);
