 ...
 * @date 2022/7/4 14:08
 */
public class CzSpc302SWRuleDProcessFunction extends ProcessFunction<SpcCz302SWDetailDTO, SpcCz302SWDetailDTO> implements SpcProcessService {
    ...
    public void processElement(SpcCz302SWDetailDTO value, ProcessFunction<SpcCz302SWDetailDTO, SpcCz302SWDetailDTO>.Context ctx, Collector<SpcCz302SWDetailDTO> out) throws Exception {
        ...
        //获取窗口
        LimitLinkedList<SpcCz302SWDetailDTO> flexDataList = windowService.getDataWindow(value.getTaskKey(), RuleKey.RULE_D, windowKey, REDIS_FLEX_TYPE_KEY, ruleValue);
        ...
        //先判断是否连续7个点在同一侧
        boolean flexOk = FlinkCommonService.hasOutTagRuleD(value, ruleEntity.getRuleValueInt(),
                ...
                () -> {
                    return flexDataList.stream().map(s -> {
                        ...
                        dataAroundDTO.setTarget(s.getMiddle());
