 ...
 * @date 2022/7/4 14:08
 */
public class CzSpc302BDHRuleBProcessFunction extends ProcessFunction<SpcCz302BDHDetailDTO, SpcCz302BDHDetailDTO> implements SpcProcessService {
    ...
    public void processElement(SpcCz302BDHDetailDTO value, ProcessFunction<SpcCz302BDHDetailDTO, SpcCz302BDHDetailDTO>.Context ctx, Collector<SpcCz302BDHDetailDTO> out) throws Exception {
        ...
        //获取窗口
        LimitLinkedList<SpcCz302BDHDetailDTO> flexDataList = windowService.getDataWindow(value.getTaskKey(), RuleKey.RULE_B, windowKey, REDIS_FLEX_TYPE_KEY, ruleValue);
