 ...
 * @date 2022/7/4 14:08
 */
public class CzSpc302DPRuleDProcessFunction extends ProcessFunction<SpcCz302DPDetailDTO, SpcCz302DPDetailDTO> implements SpcProcessService {
    ...
    public void processElement(SpcCz302DPDetailDTO value, ProcessFunction<SpcCz302DPDetailDTO, SpcCz302DPDetailDTO>.Context ctx, Collector<SpcCz302DPDetailDTO> out) throws Exception {
        ...
        //获取窗口
        LimitLinkedList<SpcCz302DPDetailDTO> flexDataList = windowService.getDataWindow(value.getTaskKey(), RuleKey.RULE_D, windowKey, REDIS_FLEX_TYPE_KEY, ruleValue);
        ...
        //获取窗口
        LimitLinkedList<SpcCz302DPDetailDTO> weightDataList = windowService.getDataWindow(value.getTaskKey(), RuleKey.RULE_D, windowKey, REDIS_WEIGHT_TYPE_KEY, ruleValue);
        ...
        boolean weightOk = FlinkCommonService.hasOutTagRuleD(value, ruleEntity.getRuleValueInt(), WEIGHT_TITLE,
                ...
                () -> {
                    return weightDataList.stream().map(s -> {
                        ...
                        dataAroundDTO.setTarget(s.getMiddleReduceWeight());
                        return dataAroundDTO;
                    }).collect(Collectors.toList());
                },
                () -> {
