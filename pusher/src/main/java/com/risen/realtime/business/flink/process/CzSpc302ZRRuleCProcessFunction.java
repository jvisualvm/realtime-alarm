 ...
 * @date 2022/7/4 14:08
 */
public class CzSpc302ZRRuleCProcessFunction extends ProcessFunction<SpcCz302ZRDetailDTO, SpcCz302ZRDetailDTO> implements SpcProcessService {
    ...
    public void processElement(SpcCz302ZRDetailDTO value, ProcessFunction<SpcCz302ZRDetailDTO, SpcCz302ZRDetailDTO>.Context ctx, Collector<SpcCz302ZRDetailDTO> out) throws Exception {
        ...
        //获取窗口
        LimitLinkedList<SpcCz302ZRDetailDTO> flexDataList = windowService.getDataWindow(value.getTaskKey(), RuleKey.RULE_C, windowKey, REDIS_FLEX_TYPE_KEY, ruleValue);
        ...
        //获取窗口
        LimitLinkedList<SpcCz302ZRDetailDTO> weightDataList = windowService.getDataWindow(value.getTaskKey(), RuleKey.RULE_C, windowKey, REDIS_WEIGHT_TYPE_KEY, ruleValue);
