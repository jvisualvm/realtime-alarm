 ...
 * @date 2022/7/4 14:08
 */
public class CzSpc302BMRuleDProcessFunction extends ProcessFunction<SpcCz302BMDetailDTO, SpcCz302BMDetailDTO> implements SpcProcessService {
    ...
    public void processElement(SpcCz302BMDetailDTO value, ProcessFunction<SpcCz302BMDetailDTO, SpcCz302BMDetailDTO>.Context ctx, Collector<SpcCz302BMDetailDTO> out) throws Exception {
        ...
        //获取窗口
        LimitLinkedList<SpcCz302BMDetailDTO> flexDataList = windowService.getDataWindow(value.getTaskKey(), RuleKey.RULE_D, windowKey, REDIS_FLEX_TYPE_KEY, ruleValue);
